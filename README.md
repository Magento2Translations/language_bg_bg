...
# Version & progress
This translation is generated from the branch [2.2.2](https://crowdin.com/project/magento-2/bg#/2.2.2) at Crowdin and based on the Magento 2.2.2 sourcefiles.
There have been  7304 strings translated of the 9734 strings in the Magento source.
...
composer require magento2translations/language_bg_bg:2.2.2-dev
php bin/magento cache:clean
```
## Manually
To install this language package manually you need access to your server file system.
* Download the zip file [here](https://github.com/Magento2Translations/language_bg_bg/archive/2.2.2.zip).
